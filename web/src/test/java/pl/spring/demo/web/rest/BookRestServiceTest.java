...
public class BookRestServiceTest {
	...
	public void testShouldCallBookService() throws Exception {
		...
		final BookTo bookTo1 = new BookTo(1L, bookTitle, new HashSet<>(
				Arrays.asList(new AuthorTo(1L, "Author1", "Author1"))));
		final BookTo bookTo2 = new BookTo(2L, bookTitle, new HashSet<>(
				Arrays.asList(new AuthorTo(2L, "Author2", "Author2"))));

		Mockito.when(bookService.findBooksByTitle(bookTitle))
	...
	public void testShouldSaveBook() throws Exception {
		// given
		File file = FileUtils.getFileFromClasspath(
